...
export function formatCadenceSchedule(
  template: Pick<CheckTemplate, "cadence" | "dayOfWeek" | "dayOfMonth">
): string {
  switch (template.cadence) {
    case "DAILY":
      return "Every day";
    ...
    case "MONTHLY":
      return template.dayOfMonth
        ...
        : "Every month";
    default:
      return CADENCE_LABELS[template.cadence as CheckCadenceValue] ?? template.cadence;
  }
}
